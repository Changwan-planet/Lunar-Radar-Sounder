...
Character(len=255) :: FN_in='DTMSAR_Cut_ac_2km_N15E300N12E303SC.txt'
Character(len=255) :: FN_in2='reOrbit_W58.15_parsing_12_15_ac.txt'

!Character(len=255) :: FN_out="Denoised_DTM1113.txt"
Character(len=255) :: FN_out2='DTM_Average_ac_2km_N15E300N12E303SC.txt'
...
Real :: Altitude(1157)
Real :: LRS_Lat(1157)
Real :: Denoised_El(81,277)
Real :: DTM_Average(1157)
Real :: Degree
...
Open(unit=15, file=FN_out2, status='replace')
...
!----------------------------------------------------------------------!
            ...
            DTM_Average(n)=SUM(Denoised_El)/Size(Denoised_El)
            Write(*,*) 'Latitude',LRS_Info(1,n),'H_nadir',LRS_Info(5,n),'DTM_Average',DTM_Average(n)
            Write(15,*)LRS_Info(1,n),LRS_Info(5,n),DTM_Average(n)
